	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_giftcertificates_domain_model_cart.pid=###CURRENT_PID### AND tx_giftcertificates_domain_model_cart.sys_language_uid IN (-1,0)',
			),
		),
		...
		'total_value' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:giftcertificates/Resources/Private/Language/locallang_db.xml:tx_giftcertificates_domain_model_cart.total_value',
			'config' => array(
				'type' => 'input',
				'size' => 30,
