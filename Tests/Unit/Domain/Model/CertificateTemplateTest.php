...
/**
 * Test case for class Tx_Giftcertificates_Domain_Model_CertificateTemplate.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Domain_Model_CertificateTemplateTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_Giftcertificates_Domain_Model_CertificateTemplate();
	}
	...
	public function setPreviewImageForStringSetsPreviewImage() { 
		$this->fixture->setPreviewImage('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getPreviewImage()
		);
	}
	 ...
	 * @test
	 */
	public function getMinimumValueReturnsInitialValueForFloat() { 
		$this->assertSame(
			0.0,
			$this->fixture->getMinimumValue()
		);
	}
	 ...
	 * @test
	 */
	public function setMinimumValueForFloatSetsMinimumValue() { 
		$this->fixture->setMinimumValue(3.14159265);
	 ...
	 * @test
	 */
	public function getMaximumValueReturnsInitialValueForFloat() { 
		$this->assertSame(
			0.0,
			$this->fixture->getMaximumValue()
		);
	}
	 ...
	 * @test
	 */
	public function setMaximumValueForFloatSetsMaximumValue() { 
		$this->fixture->setMaximumValue(3.14159265);
	 ...
	 * @test
	 */
	public function initialCertificateTemplateIsAValueCoupon() {
		$this->assertEquals(FALSE, $this->fixture->getIsPropertyCoupon());
	}

	/**
	 * @test
	 */
	public function getIsPropertyCouponIsTrueIfArticlesAreAdded() {
		$article = new Tx_Giftcertificates_Domain_Model_Article();
		$objectStorageHoldingExactlyOneArticle = new Tx_Extbase_Persistence_ObjectStorage();
		$objectStorageHoldingExactlyOneArticle->attach($article);
		$this->fixture->addArticle($article);
		...
		$this->assertEquals(
			TRUE,
			$this->fixture->getIsPropertyCoupon()
		);
	}
	 ...
	 * @test
	 */
	public function getIsPropertyCouponIsTrueIfCategoriesAreAdded() {
		$category = new Tx_Giftcertificates_Domain_Model_Category();
		$objectStorageHoldingExactlyOneCategory = new Tx_Extbase_Persistence_ObjectStorage();
		$objectStorageHoldingExactlyOneCategory->attach($category);
		$this->fixture->addCategory($category);
