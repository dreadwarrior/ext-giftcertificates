...
/**
 * Test case for class Tx_Giftcertificates_Domain_Model_BillingAddress.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Domain_Model_BillingAddressTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
