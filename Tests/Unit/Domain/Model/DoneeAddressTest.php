...
/**
 * Test case for class Tx_Giftcertificates_Domain_Model_DoneeAddress.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Domain_Model_DoneeAddressTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
