...
/**
 * Test case for class Tx_Giftcertificates_Domain_Model_CertificateArticle.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Domain_Model_CertificateArticleTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
