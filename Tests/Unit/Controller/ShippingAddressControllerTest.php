...
/**
 * Test case for class Tx_Giftcertificates_Controller_ShippingAddressController.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Controller_ShippingAddressControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
