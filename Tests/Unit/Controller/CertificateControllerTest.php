...
/**
 * Test case for class Tx_Giftcertificates_Controller_CertificateController.
 *
 * @version $Id$
 ...
 */
class Tx_Giftcertificates_Controller_CertificateControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
